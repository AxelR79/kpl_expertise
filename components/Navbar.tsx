...
const Navbar = () => {
  ...
  const menuItems = useMemo(() => (
    <>
      ...
      <a className="font-montserrat text-xl not-italic font-extrabold uppercase text-center text-white-50 hover:text-white transition-colors duration-300" href="/accueil">accueil</a>
      <a className="font-montserrat text-xl not-italic font-extrabold uppercase text-center text-white-50 hover:text-white transition-colors duration-300" href="/etude-retraite">étude retraite</a>
      <a className="font-montserrat text-xl not-italic font-extrabold uppercase text-center text-white-50 hover:text-white transition-colors duration-300" href="/demarche-administratives">démarches administratives</a>
      <a className="font-montserrat text-xl not-italic font-extrabold uppercase text-center text-white-50 hover:text-white transition-colors duration-300" href="/temoignages">témoignages</a>
      <a className="font-montserrat text-xl not-italic font-extrabold uppercase text-center text-white-50 hover:text-white transition-colors duration-300" href="/contact">contact</a>
    </>
  ), []);
  ...
  return (
    <>
      {isMobile ? (
        <header className={`menu h-full w-20 bg-red flex-col ${isMenuOpen ? 'open w-56' : ''} transition-all duration-300 ease-out fixed`}>
          <div className="menu-icon cursor-pointer p-4 w-20" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            {isMenuOpen ? (
        ...
        <header className="h-full bs:h-28 ms:w-56 bs:w-full bg-red flex bs:justify-center items-center bs:sticky fixed">
